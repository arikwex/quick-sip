...
module.exports = function(gulp, newBrowserifyOptions) {
  ...
  return {
    createBundler: function() {
      console.log(options.browserify);
      watchify.args.debug = options.browserify.debug;
      browserifyBundler = browserify(watchify.args, options.browserify);
    ...
    createWatchifyBundler: function() {
      watchify.args.debug = options.browserify.debug;
      browserifyBundler = watchify(browserify(watchify.args, options.browserify));
